...
def load_map(filename):
    im = mpimg.imread("C:/Users/kevin/OneDrive/Desktop/lab2/" + filename)
    im_np = np.array(im)  #Whitespace is true, black is false
    #im_np = np.logical_not(im_np)    
    return im_np

def load_map_yaml(filename):
    with open("C:/Users/kevin/OneDrive/Desktop/lab2/" + filename, "r") as stream:
...
class PathPlanner:
    ...
    # Add a transpose if needs it to be flipped
