...
class CNN(torch.nn.Module):
    def __init__(self, num_bins): 
        ...
        self.fc1 = torch.nn.Linear(224,64) # First fully connected layer with 224 inputs and 64 outputs
        self.drop = torch.nn.Dropout(p=0.5) # Drop out after first fully connected layer
        self.fc2 = torch.nn.Linear(64,num_bins) # Second fully connected lauer with 64 inputs and 8 outputs
