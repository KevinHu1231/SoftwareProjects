...
class CNN(torch.nn.Module):
    def __init__(self, num_bins): 
        ...
        self.conv1 = torch.nn.Conv2d(3, 16, stride=1, kernel_size=(9,9)) # 3 input channels, 16 output channels
        ...
        self.fc1 = torch.nn.Linear(1344, 512)
        self.fc2 = torch.nn.Linear(512,num_bins)
        self.drop = torch.nn.Dropout(0.5)
        # self.fc = torch.nn.Conv2d(32,num_bins, kernel_size=(5,22))
    ...
    #     self.fc1 = torch.nn.Linear(11872, 1024)
    #     self.fc2 = torch.nn.Linear(1024, 84)
    #     self.fc3 = torch.nn.Linear(84, num_bins)
    #     self.relu = torch.nn.ReLU()
...
class dataloader(torch.utils.data.Dataset):
    ...
    def normalize_to_zero_mean(self):
        #---FILL ME IN-----
        # plt.imshow(np.moveaxis(self.images[0,:,:,:]/256,0,-1))
        # plt.show()
