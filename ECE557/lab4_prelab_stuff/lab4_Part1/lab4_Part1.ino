...
// SECTION 1: CONTROL PARAMETERS - to be modified by students
  ...
  double T_sample = 0.0001; //seconds
...
void takeReading(){
  if (calibrated==1){
    ...
    x1_hat_dot = (a11 - L_11) * x1_hat + (a12 - L_12) * x2_hat + a13 * x3_hat + a14 * x4_hat + b1 * u + L_11 * a + L12 * b;
    x2_hat_dot = (a21 - L_21) * x1_hat + (a22 - L_22) * x2_hat + a23 * x3_hat + a24 * x4_hat + b2 * u + L_21 * a + L22 * b; 
    x3_hat_dot = (a31 - L_31) * x1_hat + (a32 - L_32) * x2_hat + a33 * x3_hat + a34 * x4_hat + b3 * u + L_31 * a + L32 * b;
    x4_hat_dot = (a41 - L_41) * x1_hat + (a42 - L_42) * x2_hat + a43 * x3_hat + a44 * x4_hat + b4 * u + L_41 * a + L42 * b;
