...
// Controller's gains Part 0
//  double k1 = 33.5095;
//  double k2 = -98.0971;
//  double k3 = 34.6442;
//  double k4 = -17.3472;

// Controller's gains Part 1
//double k1 = 44.7214;
//double k2 = -136.7668;
//double k3 = 39.1390;
//double k4 = -18.6726;
...
void takeReading(){
  if (calibrated==1){
    ...
    float y_meas = K_encoder * encoderPos - x_sg;
    float theta_meas = K_encoder_P * encoderPos_P;
    x1_hat_dot = (a11 - L_11) * x1_hat + (a12 - L_12) * x2_hat + (a13) * x3_hat + (a14) * x4_hat + (b1) * u + (L_11) * y_meas + (L_12) * theta_meas;
    x2_hat_dot = (a21 - L_21) * x1_hat + (a22 - L_22) * x2_hat + (a23) * x3_hat + (a24) * x4_hat + (b2) * u + (L_21) * y_meas + (L_22) * theta_meas; 
    x3_hat_dot = (a31 - L_31) * x1_hat + (a32 - L_32) * x2_hat + (a33) * x3_hat + (a34) * x4_hat + (b3) * u + (L_31) * y_meas + (L_32) * theta_meas;
    x4_hat_dot = (a41 - L_41) * x1_hat + (a42 - L_42) * x2_hat + (a43) * x3_hat + (a44) * x4_hat + (b4) * u + (L_41) * y_meas + (L_42) * theta_meas;
