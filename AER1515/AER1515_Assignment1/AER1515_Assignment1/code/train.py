...
def main():
    ...
    main_path = "C:/Users/kevin/OneDrive/Desktop/AER1515_Assignment1/AER1515_Assignment1/AnimalFace/train/"
    paths = []
    labels = []
    ...
    for epoch in range(1, EPOCH_NUMBER + 1):
        ...
        for data_, target_ in validation_loader:
            ...
            # Compute loss
            epoch_loss_val = epoch_loss_val + loss.item()
        #################################
        ...
        # Your Code
        VALIDATION_LOSS.append(epoch_loss_val/len(validation_loader))
        print(f"Epoch {epoch}, Validation Loss: {epoch_loss_val/len(validation_loader)}")
        ##############################################################################
        ...
        #if ((epoch_loss_val/len(validation_loader))<min_loss):
    ...
    plt.plot(range(EPOCH_NUMBER), VALIDATION_LOSS, color="orange", label="Validation Set")
    plt.legend()
